...
var gulp = require('gulp'),
    ...
    clean = require('gulp-clean'),//清理文件f
...
gulp.task('dev-jade-min',function () {
    gulp.src([
        '!./views/error.jade',
        '!./views/layout.jade',
        '!./views/jslib/**/*.jade',//不编译组件文件
        './views/**/*.jade'//编译页面文件
...
gulp.task('dev-image-min', function() {
...
gulp.task('watch', function() {
    gulp.watch(['./public/javascripts/**/*.*','config/**/*.*','./public/stylesheets/**/*.*','./views/**/*.*','routes/**/*.*'],
        ['jshint','dev-js-min','dev-css-min'/*,'dev-image-min','dev-jade-min'*/]);
});

gulp.task('default',['dev-js-min','dev-css-min'/*,'dev-image-min','dev-jade-min'*/,'copySourceCoceHttpxDev']);

gulp.task('dev',['default','watch','browser-sync']);

gulp.task('build',['dev-jade-min','dev-image-min','copy2']);
/************************************************
 dev env tasks end
 ************************************************/
